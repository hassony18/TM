...
function nextVoc(type) {
	if (type == "start") {
		...
		window.location.replace('italien.php');
	}
	document.getElementById("faceText").innerHTML = learningTable[currentNumberInQueue][0] // italian text
